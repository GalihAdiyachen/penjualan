...
<head>
  ...
  <title>RESELLER | PT Nashir</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">E-Reseller</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?= $menu=='dashboard'?'menu-open' : '' ?>" >
          ...
          <li class="nav-item">
            <a href="<?= base_url('Admin/Setting') ?>" class="nav-link <?= $menu=='stting'?'active' : '' ?>" >
 ...
 <div class="content-wrapper">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>ADT &copy; 2024 <a href="https://adminlte.io">PT. Niaga Wasillah Alkhair</a>.</strong>NASHIR
  </footer>
</div>
<!-- ./wrapper -->
